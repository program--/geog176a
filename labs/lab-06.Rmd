...
# Terrain Analysis
```{r}
whitebox::wbt_hillshade("labs/data/basin-boundary-elev.tif", "labs/data/basin-elev-hillshade.tif")
basin_hillshade <- raster::raster("labs/data/basin-elev-hillshade.tif")
